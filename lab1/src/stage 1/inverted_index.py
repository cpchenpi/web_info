...
if __name__ == "__main__":
    ...
    # l.build_from_idlist("lab1/data/Book_id.csv")
    # l.save("lab1/data/Book_inverted.bin")
    # l.load("lab1/data/Book_inverted.bin")
    # l.save_compressed("lab1/data/Book_inverted_compressed.bin")
    ...
    # l.build_from_idlist("lab1/data/Movie_id.csv")
    # l.save("lab1/data/Movie_inverted.bin")
    # l.load("lab1/data/Movie_inverted.bin")
    # l.save_compressed("lab1/data/Movie_inverted_compressed.bin")
